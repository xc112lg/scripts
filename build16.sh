...
grep -q 'allow_undefined_symbols: true,' vendor/xiaomi/sm8150-common/Android.bp || sed -i '/cc_prebuilt_library_shared\s*{/,/}/{
/name:[[:space:]]*"libwfdservice",[[:space:]]*$/,/}/{
/system_ext_specific:[[:space:]]*true,[[:space:]]*$/a\
